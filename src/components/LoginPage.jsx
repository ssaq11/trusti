      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-slate-900 rounded-2xl shadow-sm p-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 bg-white border border-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 text-sm flex items-center justify-center gap-2"
          >
